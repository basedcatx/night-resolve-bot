...
test("Creates an instance of a ChannelManager Object, from the channel factory's fromId() method, and checks if it is an instance of a TextChannelManager, VoiceChannelManager or ThreadChannelManager", function check() {
